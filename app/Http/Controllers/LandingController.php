...
class LandingController extends Controller
{
    ...
    {
        $showPricing = (bool) config('vetsap.landing.show_pricing', false);
        ...
        return Inertia::render('landing/index', [
            ...
            'seo' => [
                ...
                'description' => $showPricing
                    ? 'Organiza tu clínica veterinaria con web pública, citas en línea, gestión de pacientes y boletas electrónicas SII. Plan gratuito disponible.'
                    : 'Organiza tu clínica veterinaria con web pública, citas en línea, gestión de pacientes y boletas electrónicas SII.',
                'canonical' => url('/'),
                'og_image' => url('/images/seo/og-landing.png'),
                'og_type' => 'website',
                'json_ld' => [
                    self::schemaOrganization(),
                    self::schemaSoftwareApplication($showPricing),
                    self::schemaFaqPage($showPricing),
                ],
            ],
        ]);
    }
    ...
    private static function schemaSoftwareApplication(bool $showPricing): array
    {
        $schema = [
            '@context' => 'https://schema.org',
    ...
    private static function schemaFaqPage(bool $showPricing): array
    {
        $pricingQuestions = [
            [
                '@type' => 'Question',
        ...
        return [
            '@context' => 'https://schema.org',
            '@type' => 'FAQPage',
            'mainEntity' => $showPricing
                ? [...$pricingQuestions, ...$commonQuestions]
                : $commonQuestions,
        ];
    }
}
