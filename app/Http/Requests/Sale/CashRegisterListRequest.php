...
class CashRegisterListRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort' => ['nullable', 'string', Rule::in(CashRegister::SORTABLE_COLUMNS)],
            'direction' => ['nullable', 'string', Rule::in(['asc', 'desc'])],
            'per_page' => ['nullable', 'integer', Rule::in([20, 50, 100])],
            'status' => ['nullable', 'string', Rule::enum(CashRegisterStatus::class)],
        ];
    }
