...
use App\Policies\Medic\DocumentTemplatesPolicy;
...
use App\Policies\Medic\VaccinationProtocolsPolicy;
use App\Policies\Purchase\ExpensesPolicy;
use App\Policies\Purchase\ExpenseTypesPolicy;
use App\Policies\Purchase\PurchaseOrdersPolicy;
use App\Policies\Purchase\PurchaseOrderStatusPolicy;
use App\Policies\Purchase\SuppliersPolicy;
use App\Policies\Sale\CashRegistersPolicy;
use App\Policies\Sale\CertificationSiiTicketsPolicy;
use App\Policies\Sale\CustomersPolicy;
use App\Policies\Sale\ReceivedPaymentsPolicy;
use App\Policies\Sale\SaleDocumentsPolicy;
...
use App\Policies\Store\InventoryMovementsPolicy;
use App\Policies\Store\MovementCategoriesPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(CashRegister::class, CashRegistersPolicy::class);
        Gate::policy(Customer::class, CustomersPolicy::class);
        Gate::policy(SaleDocument::class, SaleDocumentsPolicy::class);
        Gate::policy(SaleDocumentPayment::class, ReceivedPaymentsPolicy::class);
        Gate::policy(Supplier::class, SuppliersPolicy::class);
        Gate::policy(PurchaseOrder::class, PurchaseOrdersPolicy::class);
        Gate::policy(Expense::class, ExpensesPolicy::class);
        Gate::policy(ExpenseType::class, ExpenseTypesPolicy::class);
        Gate::policy(PurchaseOrderStatus::class, PurchaseOrderStatusPolicy::class);
        ...
        Gate::policy(DocumentTemplate::class, DocumentTemplatesPolicy::class);
        Gate::policy(VaccinationProtocol::class, VaccinationProtocolsPolicy::class);
        ...
        Gate::policy(MovementCategory::class, MovementCategoriesPolicy::class);
        Gate::policy(InventoryMovement::class, InventoryMovementsPolicy::class);
