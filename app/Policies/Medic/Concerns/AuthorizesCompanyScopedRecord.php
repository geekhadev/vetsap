...
trait AuthorizesCompanyScopedRecord
{
    ...
    public function view(User $user, Doctor|Service|Specialty|Species $record): bool
    {
        return $this->canList($user)
    ...
    public function update(User $user, Doctor|Service|Specialty|Species $record): bool
    {
        return $this->canUpdate($user)
            && $this->sessionCompanyMatches((string) $record->company_id);
    }

    public function delete(User $user, Doctor|Service|Specialty|Species $record): bool
    {
        return $this->canDelete($user)
            && $this->sessionCompanyMatches((string) $record->company_id);
    }
