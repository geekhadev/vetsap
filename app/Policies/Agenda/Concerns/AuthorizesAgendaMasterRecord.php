...
trait AuthorizesAgendaMasterRecord
{
    ...
    public function view(User $user, AppointmentStatus $record): bool
    {
        return $this->canList($user);
    }
    ...
    public function update(User $user, AppointmentStatus $record): bool
    {
        return $this->canModifyRecord($user, $record, $this->canUpdate($user));
    }

    public function delete(User $user, AppointmentStatus $record): bool
    {
        return $this->canModifyRecord($user, $record, $this->canDelete($user));
    }

    protected function canModifyRecord(User $user, AppointmentStatus $record, bool $hasAbility): bool
    {
        if (! $hasAbility) {
            return false;
        }
