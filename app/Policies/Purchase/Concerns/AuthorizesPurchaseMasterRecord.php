...
namespace App\Policies\Purchase\Concerns;
...
trait AuthorizesPurchaseMasterRecord
{
    ...
    public function view(User $user, PurchaseOrderStatus|ExpenseType $record): bool
    {
        return $this->canList($user);
    }
    ...
    public function update(User $user, PurchaseOrderStatus|ExpenseType $record): bool
    {
        return $this->canModifyRecord($user, $record, $this->canUpdate($user));
    }

    public function delete(User $user, PurchaseOrderStatus|ExpenseType $record): bool
    {
        return $this->canModifyRecord($user, $record, $this->canDelete($user));
    }

    protected function canModifyRecord(User $user, PurchaseOrderStatus|ExpenseType $record, bool $hasAbility): bool
    {
        if (! $hasAbility) {
            return false;
        }
