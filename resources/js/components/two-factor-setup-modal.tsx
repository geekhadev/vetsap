    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticación en dos pasos está activa. Escanea el código QR o introduce la clave en tu app de autenticación.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para terminar de activar la autenticación en dos pasos, escanea el código QR o introduce la clave en tu app de autenticación',
            buttonText: 'Continuar',
        };
