...
/** Official Google Calendar product mark (2020). */
...
/** iOS Calendar app icon (live weekday + day number). */
export function AppleCalendarIcon({ className }: BrandIconProps) {
    const clipId = useId().replaceAll(':', '');
    const now = new Date();
    const weekday = now.toLocaleDateString('es-CL', { weekday: 'long' }).toUpperCase();
