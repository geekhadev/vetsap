...
import type { Supplier, SuppliersIndexFiltersDraftFull } from './types';

type SuppliersIndexFiltersProps = Pick<
    TabledataListPageViewModel<Supplier, SuppliersIndexFiltersDraftFull>,
    'filters' | 'setFilter' | 'applyFilters' | 'resetFilters'
>;

export function SuppliersIndexFilters({
    filters,
    setFilter,
    applyFilters,
    resetFilters,
}: SuppliersIndexFiltersProps) {
